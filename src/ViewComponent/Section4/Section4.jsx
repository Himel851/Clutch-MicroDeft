...
import { AiOutlineThunderbolt, AiFillStar, AiOutlineRight } from 'react-icons/ai'
...
const Section4 = () => {
  return (
    <div >
      ...
      <Container className={style.section4}>
        <Row>
          ...
          <Col sm={6} className={style.featureCol2}>
            <Container>
              ...
              <Row>
                ...
                <p>EIGHT25MEDIA delivered a visually appealing, functional, and user-friendly website that was met with a positive response. It resulted in increased visits and received interest from executive leadership. The team managed Review excellently, and they were an extremely skilled design partner.</p>
